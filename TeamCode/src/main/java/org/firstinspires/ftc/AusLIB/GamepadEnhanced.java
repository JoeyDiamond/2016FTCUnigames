...
public class GamepadEnhanced {
    ...
    /**
     * Used to change what gamepad this class refernces
     * @param gpad This Gamepad will be the controller that this instance of the class references.
     */
     ...
     * @param button the button or axis to be checked
     * @return true if hte previous state was not pressed and the current state is pressed, false otherwise
     */
     ...
     * @return was the value previously outside the button threshhold and now is considered pressed
     */
    ...
    /**
     * Reads any axis as a boolean button, checking if axis value is greater than threshhold value
     * @param axis the axis to be checked
    ...
    ////////////////////////////////////////////////////////////////
    // getters. setters specifically not implimented because all
