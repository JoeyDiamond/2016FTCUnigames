...
/**
 * Created by sailo on 5/19/2016.
 */
public class InternalOrientation extends Activity implements SensorEventListener{
    /* sensor data */
    ...
    public InternalOrientation(){
        super();
        Log.d("state","completed super method");
    ...
    public void onCreate(Bundle savedInstanceState) {
        for(int i=0;i<10;i++)
            Log.d("state", "state: running onCreate");
