...
import org.firstinspires.ftc.teamcode.UniGames.behaviors.StoreLiftAndUnhook;
...
@TeleOp(name="Unigames Teleop", group="Opmode")  // @Autonomous(...) is the other common choice
public class UnigamesTeleop extends OpMode {
    ...
    public void loop() {
        ...
        operatorGamepad.update(gamepad2);
        ...
        if(operatorGamepad.getAxisAsButton(GamepadEnhanced.AXIS.AXIS_LEFT_TRIGGER)){
